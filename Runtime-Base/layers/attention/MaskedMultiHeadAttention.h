...
class MaskedMultiHeadAttention {
    ...
    MaskedSelfAttention self_att = MaskedSelfAttention();

public:
    explicit MaskedMultiHeadAttention(LLI D, LLI N_HEAD=1) : D(D), N_HEAD(N_HEAD), out_proj(Linear(D, D)),
